...
export default function ProjectSection() {
  return (
    <div className='mt10 flex flex-col justify-center items-center'>
      ...
      <CarouselDarkVariantExample title={"American Roofing Next.js Project"} path={["/am_roof/slide1.png","/am_roof/slide2.png","/am_roof/slide3.png"]} label={["Front Page","FAQs Section","Footer"]}/>
    </div>
  )
}
